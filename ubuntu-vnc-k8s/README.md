---
name: Develop in Kubernetes on a Remote Desktop
description: Get started with Kubernetes development in a remote desktop.
...
This template creates a pod running the `codercom/enterprise-vnc:ubuntu` image.
